"""
Contains functions relavant to inference
"""
...
def embed_frames_batch(frames_batch):
    """
    Computes embedding for a batch of mel spectrogram.

    :param frames_batch: a batch of mel spectrogram as a numpy array of float32 of shape
...
def compute_partial_slices(n_samples, partial_utterance_n_frames=PARTIALS_N_FRAMES,
    ...
    recommended that you pad the waveform with zeros up wave_slices[-1].stop.
    ...
    # Evaluate whether the extra padding is warranted or not
...
def plot_embedding_as_heatmap(embed, ax=None, title="", shape=None, color_range=(0.0, 0.30)):
    if ax is None:
        ax = plt.gca()
